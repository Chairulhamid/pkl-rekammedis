...
<div class="container-fluid">
  ...
  <div>
    ...
    <a href="<?= base_url('Welcome/b_printIM') ?>" class="btn btn-danger mb-3" target="blank"><i class="fas fa-print"></i> Print</a>
  </div>

  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary text-center">Data Imunisasi </h6>
    </div>
    <div class="card-body">
            ...
            ?>
              <tr>
                ...
                <td>
                  ...
                  <a href="javascript:;" class="btn btn-danger" data-toggle="modal" data-target=".bd-example-modal-sm" data-nama="<?= $pu['namaP']; ?>" data-href="<?= base_url('Welcome/hapusIM/' . $pu['id']) ?>"><i class="fa fa-trash"></i></a>
                </td>
              </tr>
