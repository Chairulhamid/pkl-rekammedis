...
<div class="container-fluid">
  ...
  <div>
    ...
    <a href="<?= base_url('Welcome/b_printPU') ?>" class="btn btn-danger mb-3" target="_blank"><i class="fas fa-print"></i> Print</a>
  </div>
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td><?= $pu['alamat']; ?></td>
                <td>
                  <a href="javascript:;" class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg" data-namakk="<?= $pu['namakk']; ?>" data-nokartu="<?= $pu['nokartu']; ?>" data-nama="<?= $pu['namaP']; ?>" data-kelamin="<?= $pu['jeniskel']; ?>" data-umur="<?= $pu['umur']; ?>" data-alamat="<?= $pu['alamat']; ?>" data-jenisk="<?= $pu['jenis_kunjungan']; ?>" data-keluhan="<?= $pu['keluhan_pu']; ?>" data-diagnosa="<?= $pu['diagnosa_pu']; ?>" data-pengobatan="<?= $pu['pengobatan_pu']; ?>" data-konsul="<?= $pu['konsl_pu']; ?>" data-petugas="<?= $pu['petugas_pu']; ?>"><i class="fas fa-search"></i></a>
                  <a href="#" class="btn btn-danger" data-toggle="modal" data-target=".bd-example-modal-sm" data-nama="<?= $pu['namaP']; ?>" data-href="<?= base_url('Welcome/hapusPU/' . $pu['id_pu']) ?>"><i class="fa fa-trash"></i></a>
                </td>
              </tr>
