...
<div class="container-fluid">
  ...
  <div>
    ...
    <a href="<?= base_url('Welcome/b_printIbu') ?>" class="btn btn-danger mb-3" target="blank"><i class="fas fa-print"></i> Print</a>
  </div>

  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary text-center">Data Poli Ibu</h6>
    </div>
    <div class="card-body">
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td><?= $pu['alamat']; ?></td>
                <td>
                  <a href="javascript:;" class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg" data-namakk="<?= $pu['namakk']; ?>" data-nokartu="<?= $pu['nokartu']; ?>" data-nama="<?= $pu['namaP']; ?>" data-kelamin="<?= $pu['jeniskel']; ?>" data-umur="<?= $pu['umur']; ?>" data-alamat="<?= $pu['alamat']; ?>" data-jenisk="<?= $pu['jenisk']; ?>" data-keluhan="<?= $pu['keluhan']; ?>" data-diagnosa="<?= $pu['diagnosa']; ?>" data-pengobatan="<?= $pu['pengo']; ?>" data-konsul="<?= $pu['kosnl']; ?>" data-petugas="<?= $pu['tenagam']; ?>"><i class="fas fa-search"></i></a>
                  <a href="javascript:;" class="btn btn-danger" data-toggle="modal" data-target=".bd-example-modal-sm" data-nama="<?= $pu['namaP']; ?>" data-href="<?= base_url('Welcome/hapusIB/' . $pu['id']) ?>"><i class="fa fa-trash"></i></a>
                </td>
              </tr>
