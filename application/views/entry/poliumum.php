...
<script type="text/javascript">
  function sum() {
    let tinggi = document.getElementById('tgi').value;
    let bert = document.getElementById('bb').value;
    let imt_ = parseInt(bert) / ((parseInt(tinggi) * 2) / 100);
    let num = imt_.toFixed(2);
    if (!isNaN(num)) {
