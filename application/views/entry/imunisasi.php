        ...
        <div class="form-row justify-content-center">
          <div class="col-md-5">
            ...
            <div>
              ...
              <input type="date" class="form-control" name="tggalhr" id="tnggalhr" onchange="cnAge()">
            </div>
          </div>
          <div class="col-md-5">
            <div>
              <small>Umur</small>
              <input type="text" class="form-control" name="umur" id="umur_">
            </div>
            <div>
              <small>Alamat</small>
        ...
        <div class="form-row justify-content-around">
          <div class="col-md-3">
            ...
            <div class="input-group mb-3">
              <input type="text" class="form-control" learia-describedby="tnggi" name="tnggi" maxlength="4">
      ...
      <div class="form-group">
        ...
        <div class="form-row justify-content-around">
          ...
          <div class="col-md-3">
            ...
            <div class="input-group">
              <input type="text" class="form-control" aria-describedby="gdarah" name="gdarah" maxlength="4">
              <div class="input-group-append">
          ...
          <div class="col-md-3">
            ...
            <div class="input-group">
              <input type="text" class="form-control" aria-describedby="pdarahp" name="pdarah" maxlength="4">
              <div class="input-group-append">
...
<script type="text/javascript">
  function cnAge() {
    var baru = document.getElementById("tnggalhr").value;
    var today = "";
